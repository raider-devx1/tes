        ...
        <div class="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 space-y-6 lg:space-y-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-6">
                ...
                <div class="xl:col-span-2 rounded-2xl bg-[#0047d6] p-6 sm:p-8 lg:p-10 text-white shadow-sm flex flex-col justify-center">
                    <p class="text-sm font-semibold text-white/80">Ruang Siswa PKL</p>
                    ...
                    <p class="mt-2 text-white/85 font-medium lg:text-lg max-w-2xl">
                        Pilih menu di bawah ini untuk mengelola aktivitas magang industri Anda.
                    </p>
                </div>

                {{-- Panel statistik (mengisi 1/3 layar di PC, 2 kolom di HP) --}}
                <div class="grid grid-cols-2 gap-3 sm:gap-4">
                    <div class="rounded-2xl bg-white border border-slate-100 p-4 lg:p-5 shadow-sm flex flex-col justify-center">
                        <p class="text-xs font-bold uppercase tracking-wide text-slate-400">Total Jurnal Diisi</p>
                        <p class="mt-1 text-3xl lg:text-4xl font-extrabold text-[#0047d6]">{{ $jumlahJurnal ?? 0 }}</p>
                    </div>
                    <div class="rounded-2xl bg-white border border-slate-100 p-4 lg:p-5 shadow-sm flex flex-col justify-center">
                        <p class="text-xs font-bold uppercase tracking-wide text-slate-400">Disetujui Instruktur</p>
                        <p class="mt-1 text-3xl lg:text-4xl font-extrabold text-emerald-600">{{ $jurnalDisetujui ?? 0 }}</p>
                    </div>
                </div>
            ...
            <a href="{{ route('siswa.jurnal.index') }}"
               class="group flex items-center gap-4 rounded-2xl bg-[#0047d6] px-5 py-5 lg:px-8 lg:py-6 text-white shadow-md active:scale-[0.99] hover:brightness-105 transition">
                ...
                <div class="min-w-0 flex-1">
                    <h4 class="text-lg sm:text-xl lg:text-2xl font-bold">Jurnal Kegiatan Harian</h4>
                    <p class="text-sm lg:text-base text-white/85 leading-snug">Isi jurnal aktivitas harian Anda dan lihat feedback dari instruktur.</p>
                </div>
            ...
            <div>
                <h4 class="px-1 mb-3 text-sm font-bold uppercase tracking-wide text-slate-400">Aktivitas Harian</h4>
            ...
            {{-- ===== BANTUAN SINGKAT ===== --}}
            <div class="rounded-2xl border border-[#0047d6]/20 bg-[#0047d6]/5 px-5 py-4 text-sm lg:text-base text-[#26406e]">
