<x-app-layout title="Akun Instruktur Industri">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500">Kelola akun instruktur/pembimbing dari pihak industri.</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="py-8 text-center text-gray-400">Belum ada akun instruktur industri.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
