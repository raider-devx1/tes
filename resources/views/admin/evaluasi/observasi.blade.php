                                ...
                                <tr class="align-top transition hover:bg-[#0047d6]/5">
                                    ...
                                    <td class="px-4 py-3">
                                        <div x-data="{ showValidasi:false, showBatal:false }" class="flex flex-col items-center gap-2">
                                            ...
                                            {{-- MODAL BATAL VALIDASI DI DALAM ROW --}}
    ...
    <script>
        window.observasiCrud = function () {
            ...
            return {
                ...
                get actionUrl() { 
                    return this.mode === 'create' ? storeUrl : storeUrl + '/' + this.form.id; 
                },
                ...
                tambahItem() { 
                    this.form.items.push({ id: null, permasalahan: '', solusi: '' }); 
                },
                ...
                simpan(e) { 
                    if (!this.siswaCocok) e.preventDefault(); 
                },
