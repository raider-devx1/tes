<x-app-layout title="Tambah Industri Mitra">
    <div class="max-w-2xl">
        <h2 class="text-xl font-bold text-gray-800 mb-1">Tambah Industri Mitra</h2>
        <p class="text-sm text-gray-500 mb-6">Daftarkan perusahaan/instansi mitra PKL baru.</p>
