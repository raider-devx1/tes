<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Persetujuan Catatan Kegiatan Siswa') }}
        </h2>
    </x-slot>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 border">
                        ...
                        <tbody>
                                    ...
                                    <td class="px-4 py-3 border">
                                        ...
                                        @else
                                            ...
                                            <form action="{{ route('instruktur.catatan.approve', $item->id) }}" method="POST">
                                                ...
                                                <button type="submit" class="w-full bg-blue-600 text-white text-xs px-3 py-1.5 rounded hover:bg-blue-700">
                                                    Setujui & Simpan
                                                </button>
                                            </form>
                                        @endif
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-4 text-center">Belum ada catatan dari siswa.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
